...
This project is a tic tac toe game board built with HTML, CSS, and JavaScript. The program is a replayable mini-game.
...
git clone https://github.com/Aryangoel225/Tic-tac-toe     
...
Once the index.html file is open in your browser, you can interact with the program, using a pointer to click on the buttons, alternating between O and X. The program will tell you who won at the end or if you drew, and reset the game. 
